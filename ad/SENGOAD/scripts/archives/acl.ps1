...
SetAcl (Get-ADUser "oda.nobunaga") (Get-ADUser "oichi") "GenericAll" "None"
...
SetAcl (Get-ADUser "hattori.hanzo") (Get-ADGroup "Domain Admins") "GenericAll" "None"
...
SetAcl (Get-ADUser "toyotomi.hidetsugu") (Get-ADComputer "osaka") "GenericAll" "None"
...
SetAcl (Get-ADUser "akechi.mitsuhide") (Get-ADGroup "Domain Admins") "WriteProperty" "All"
...
SetAclExtended (Get-ADUser "oda.nobutaka") (Get-ADGroup "Domain Admins") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
...
SetAclExtended (Get-ADUser "toyotomi.hidetsugu") (Get-ADGroup "Domain Admins") "WriteProperty" "bf9679c0-0de6-11d0-a285-00aa003049e2" "All"
...
SetAclExtended (Get-ADUser "oda.nobunaga") (Get-ADUser "oda.nobutada") "ExtendedRight" "00299570-246d-11d0-a768-00aa006e0529" "None"
...
SetAcl (Get-ADUser "sen.rikyu") (Get-ADGroup "Domain Admins") "WriteOwner" "None"
...
SetAcl (Get-ADUser "oda.nobutada") (Get-ADUser "oichi") "GenericWrite" "None"
...
SetAcl (Get-ADUser "oda.nobunaga") (Get-ADGroup "Gotairo") "WriteDacl" "None"
