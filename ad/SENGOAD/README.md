...
```bash
./sengoad.sh -t install -l SENGOAD -p virtualbox -m local -r elk.yml -e elk
#or
./sengoad.sh -t install -l SENGOAD -p vmware -m local -r elk.yml -e elk
```
...
```bash
./sengoad.sh -t install -l SENGOAD -p virtualbox -m local -a -r elk.yml -e elk
#or
./sengoad.sh -t install -l SENGOAD -p vmware -m local -a -r elk.yml -e elk
```
